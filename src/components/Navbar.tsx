          ...
          <nav className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              <Link
                ...
                className="relative px-4 py-2 text-blue-900 hover:text-blue-950 transition-all duration-300 group font-medium text-sm"
              >
                {item}
            ...
            <Link
              href="/contact"
              className="ml-4 px-6 py-2 bg-blue-900 text-white font-medium rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 text-sm"
            >
              Let&apos;s Connect
            </Link>
          </nav>
