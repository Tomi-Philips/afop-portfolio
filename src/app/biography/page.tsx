      ...
      <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-blue-800 rounded-full mb-8 shadow-xl">
            ...
            <div className="w-32 h-1.5 bg-blue-800 mx-auto mt-8 rounded-full shadow-sm"></div>
          </div>
          ...
          <section className="mb-20">
            <div className="flex items-center mb-10">
              ...
              <h2 className="text-4xl font-bold text-blue-900">Early Beginnings</h2>
            </div>
          ...
          <section className="mb-20">
            <div className="flex items-center mb-10">
              ...
              <h2 className="text-4xl font-bold text-blue-900">Professional Journey</h2>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-10 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg mb-6">
                    Currently expanding knowledge in <span className="font-semibold text-blue-600">Python and Machine Learning</span> to create intelligent web systems. Seeking opportunities to contribute to innovative projects and grow within a forward-thinking development team.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-lg">
          ...
          <section className="mb-20">
            <div className="flex items-center mb-10">
              ...
              <h2 className="text-4xl font-bold text-blue-900">Academic Foundation</h2>
            </div>
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                <div className="lg:w-2/3">
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg mb-4">
                    Favour earned both his <span className="font-semibold text-blue-600">Higher National Diploma (HND)</span> and <span className="font-semibold text-blue-600">National Diploma (ND)</span> in Computer Science from Federal Polytechnic, Ilaro, Ogun State, Nigeria - building a strong academic foundation for his technical career.
                  </p>
                ...
                <div className="lg:w-1/3 bg-linear-to-br from-blue-50 to-blue-50 p-6 rounded-xl border border-blue-100">
          ...
          <section className="mb-20">
            <div className="flex items-center mb-10">
              ...
              <h2 className="text-4xl font-bold text-blue-900">Recognition & Awards</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-500 transform hover:-translate-y-2">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-linear-to-br from-blue-200 to-blue-300 rounded-xl flex items-center justify-center mr-4">
                    <span className="text-white text-xl">💼</span>
                  </div>
                  <h3 className="text-2xl font-bold text-blue-900">Professional Journey</h3>
                </div>
              ...
              <div className="group bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="space-y-6">
                  {/* HND Award */}
                  <div className="bg-linear-to-r from-blue-50 to-cyan-50 p-6 rounded-xl border-l-4 border-blue-400 hover:border-blue-500 transition-all duration-300">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Achieved the prestigious overall best graduating student award in Computer Science with an outstanding CGPA of <span className="font-bold text-blue-600">3.74/4.00</span> after completing the HND program.
                    </p>
                  </div>
                  ...
                  <div className="bg-linear-to-r from-blue-50 to-cyan-50 p-6 rounded-xl border-l-4 border-blue-400 hover:border-blue-500 transition-all duration-300">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Honored as one of the best graduating students in Computer Science with a remarkable CGPA of <span className="font-bold text-blue-600">3.70/4.00</span> after the ND program.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="text-center">
            <div className="bg-linear-to-br from-blue-700 to-blue-900 p-12 rounded-2xl shadow-2xl">
              ...
              <button className="bg-white text-blue-800 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl">
                Get In Touch
              </button>
            </div>
          </section>
